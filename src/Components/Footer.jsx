    ...
    return (
        <>
            <div className="footer-container w-screen h-[75vh] md:h-screen capitalize text-white fixed bottom-10 sm:bottom-0 z-[99] grid items-center">
                <div className="line footer w-[130%] h-[30%] absolute top-0 left-0 z-[-1] translate-x-[-14%] translate-y-[115%] rotate-[20deg] bg-customOrangeRed"></div>
                {
                ...
                <div className="footer-logo-wrapper">
                    <h2 className='text-[20vw] md:text-[22vw] md:leading-[25vh] text-center font-bold'>sundown</h2>
                </div>
