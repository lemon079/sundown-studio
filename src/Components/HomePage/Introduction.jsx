    ...
    return (
        <section className='introduction-container max-w-[1345px] mx-auto my-20 sm:my-40'>
            <div className="wrapper relative z-0 px-5 sm:px-16 md:px-16 flex flex-col md:flex-row gap-16">
                <Blob transform='translate-x-[70%] translate-y-[10%]' position='absolute top-0 left-[-40%] sm:left-0 z-[-1]' customClass='moving_blob' />
                <div className='overflow-hidden'>
                    <h2 ref={heading} className='side-1 paragraph--animate text-4xl md:text-[3.5rem] md:leading-[4rem] lg:text-[4rem] lg:pl-10'>
                ...
                <div className="side-2 w-[70%] md:w-full sm:max-w-[300px] md:max-w-full">
                    <figure className='image--animate mt-0 md:mt-32 lg:mt-40'>
                        <img src="/images/Introduction.webp" alt="tick" className='rounded-xl' loading='lazy' />
