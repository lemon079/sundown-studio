        ...
        <section className="featured-projects-container my-20">
          <div className="wrapper space-y-14">
            ...
            <div className="ml-8 link-tag-parent-animate border-[1px] w-fit rounded-full after:rounded-full after:bg-black after:top-full hover:after:top-0">
              <a
                href="#"
                className="link-tag-animate capitalize relative font-light block py-2 px-8 hover:text-white"
              >
                all projects{" "}
                <HiArrowLongRight className="ml-2 text-2xl inline-block" />
              </a>
            </div>
          </div>
        </section>
  ...
  return (
    <li className="my-10 md:my-0 max-w-[400px] md:max-w-full">
      ...
      >
        <a
          href="#"
          className="links--animate link-tag-animate lg:p-8 flex flex-col lg:flex-row justify-between lg:items-center capitalize"
        >
          <h2 className="text-4xl lg:text-5xl">{project.name}</h2>
          <h3 className="lg:text-right">
            <div className="uppercase font-medium">{project.brand}</div>
