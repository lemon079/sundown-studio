...
const Contact = () => {
  // Create a ref for the blob element
    ...
    <section className="contact-container py-20 md:py-32">
      <div className="wrapper px-10 grid grid-cols-1 gap-20 md:grid-cols-2 items-center max-w-[1320px] mx-auto">
        ...
        <section className="relative flex flex-col gap-16 md:gap-20">
          <Blob
            ref={blobRef}
            WidthHeight="w-[350px] h-[350px]"
            position="bottom-0 left-24"
            customClass="moving_blob"
          />
          <div className="text-right">
            <h1 className="uppercase text-6xl md:text-5xl lg:text-8xl">
              let's work together
            </h1>
            <a href="#" className="relative text-3xl">
              contact@sundown-studion.com
            </a>
          </div>
          <div>
            <h2 className="relative w-fit space-y-4 text-2xl">
              <p className="border-b border-black">
                Roots in Greenpoint, Brooklyn
              </p>
              <p className="border-b border-black">
                Physical work across the US
              </p>
